...
import ProductCatalogue.Food.NonPerishableGoods.Grains.*;
import ProductCatalogue.Food.NonPerishableGoods.Snacks.*;
import ProductCatalogue.Food.PerishableGoods.Fruits.*;
import ProductCatalogue.Food.PerishableGoods.Meat.*;
import ProductCatalogue.Food.PerishableGoods.Vegetable.*;
import ProductCatalogue.HouseholdCleaning.*;
import ProductCatalogue.PersonalHygine.*;
import ProductCatalogue.Food.PerishableGoods.Dairy.*;

public class WritingProductCatalogueForNewStore {
    private static HashMap<Product,Boolean> hashMap=new HashMap<>();

    public HashMap<Product,Boolean> getHashMap(){return hashMap;}
    
    public WritingProductCatalogueForNewStore(){
